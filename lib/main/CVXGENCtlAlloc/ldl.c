...
void fill_KKT(void) {
  work.KKT[26] = 2*work.quad_601932361728[0];
  work.KKT[27] = 2*work.quad_601932361728[4];
  work.KKT[28] = 2*work.quad_601932361728[8];
  work.KKT[29] = 2*work.quad_601932361728[12];
  work.KKT[32] = 2*work.quad_601932361728[5];
  work.KKT[33] = 2*work.quad_601932361728[9];
  work.KKT[34] = 2*work.quad_601932361728[13];
  work.KKT[37] = 2*work.quad_601932361728[10];
  work.KKT[38] = 2*work.quad_601932361728[14];
  work.KKT[39] = 2*work.quad_601932361728[15];
