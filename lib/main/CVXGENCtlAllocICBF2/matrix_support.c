...
void multbymG(double *lhs, double *rhs) {
  ...
  lhs[6] = -rhs[2]*(1);
  lhs[7] = -rhs[3]*(1);
  lhs[8] = -rhs[0]*(2*(params.rate_tilt[0]*params.G[0]+params.rate_tilt[1]*params.G[1]+params.rate_tilt[2]*params.G[2]))-rhs[1]*(2*(params.rate_tilt[0]*params.G[3]+params.rate_tilt[1]*params.G[4]+params.rate_tilt[2]*params.G[5]))-rhs[2]*(2*(params.rate_tilt[0]*params.G[6]+params.rate_tilt[1]*params.G[7]+params.rate_tilt[2]*params.G[8]))-rhs[3]*(2*(params.rate_tilt[0]*params.G[9]+params.rate_tilt[1]*params.G[10]+params.rate_tilt[2]*params.G[11]));
  lhs[9] = -rhs[0]*(2*(params.rate_yaw[0]*params.G[0]+params.rate_yaw[1]*params.G[1]+params.rate_yaw[2]*params.G[2]))-rhs[1]*(2*(params.rate_yaw[0]*params.G[3]+params.rate_yaw[1]*params.G[4]+params.rate_yaw[2]*params.G[5]))-rhs[2]*(2*(params.rate_yaw[0]*params.G[6]+params.rate_yaw[1]*params.G[7]+params.rate_yaw[2]*params.G[8]))-rhs[3]*(2*(params.rate_yaw[0]*params.G[9]+params.rate_yaw[1]*params.G[10]+params.rate_yaw[2]*params.G[11]));
}
void multbymGT(double *lhs, double *rhs) {
  lhs[0] = -rhs[0]*(-1)-rhs[4]*(1)-rhs[8]*(2*(params.rate_tilt[0]*params.G[0]+params.rate_tilt[1]*params.G[1]+params.rate_tilt[2]*params.G[2]))-rhs[9]*(2*(params.rate_yaw[0]*params.G[0]+params.rate_yaw[1]*params.G[1]+params.rate_yaw[2]*params.G[2]));
  lhs[1] = -rhs[1]*(-1)-rhs[5]*(1)-rhs[8]*(2*(params.rate_tilt[0]*params.G[3]+params.rate_tilt[1]*params.G[4]+params.rate_tilt[2]*params.G[5]))-rhs[9]*(2*(params.rate_yaw[0]*params.G[3]+params.rate_yaw[1]*params.G[4]+params.rate_yaw[2]*params.G[5]));
  lhs[2] = -rhs[2]*(-1)-rhs[6]*(1)-rhs[8]*(2*(params.rate_tilt[0]*params.G[6]+params.rate_tilt[1]*params.G[7]+params.rate_tilt[2]*params.G[8]))-rhs[9]*(2*(params.rate_yaw[0]*params.G[6]+params.rate_yaw[1]*params.G[7]+params.rate_yaw[2]*params.G[8]));
  lhs[3] = -rhs[3]*(-1)-rhs[7]*(1)-rhs[8]*(2*(params.rate_tilt[0]*params.G[9]+params.rate_tilt[1]*params.G[10]+params.rate_tilt[2]*params.G[11]))-rhs[9]*(2*(params.rate_yaw[0]*params.G[9]+params.rate_yaw[1]*params.G[10]+params.rate_yaw[2]*params.G[11]));
}
...
void fillh(void) {
  ...
  work.h[8] = -2*(params.rate_tilt[0]*(params.rateDot_0[0]-(params.G2[0]*params.omegaDot_0[0]+params.G2[3]*params.omegaDot_0[1]+params.G2[6]*params.omegaDot_0[2]+params.G2[9]*params.omegaDot_0[3]))+params.rate_tilt[1]*(params.rateDot_0[1]-(params.G2[1]*params.omegaDot_0[0]+params.G2[4]*params.omegaDot_0[1]+params.G2[7]*params.omegaDot_0[2]+params.G2[10]*params.omegaDot_0[3]))+params.rate_tilt[2]*(params.rateDot_0[2]-(params.G2[2]*params.omegaDot_0[0]+params.G2[5]*params.omegaDot_0[1]+params.G2[8]*params.omegaDot_0[2]+params.G2[11]*params.omegaDot_0[3])))+params.gamma_tilt[0]*(params.tiltRateMag_sq[0]-(params.rate_tilt[0]*params.rate_tilt[0]+params.rate_tilt[1]*params.rate_tilt[1]+params.rate_tilt[2]*params.rate_tilt[2]));
  work.h[9] = -2*(params.rate_yaw[0]*(params.rateDot_0[0]-(params.G2[0]*params.omegaDot_0[0]+params.G2[3]*params.omegaDot_0[1]+params.G2[6]*params.omegaDot_0[2]+params.G2[9]*params.omegaDot_0[3]))+params.rate_yaw[1]*(params.rateDot_0[1]-(params.G2[1]*params.omegaDot_0[0]+params.G2[4]*params.omegaDot_0[1]+params.G2[7]*params.omegaDot_0[2]+params.G2[10]*params.omegaDot_0[3]))+params.rate_yaw[2]*(params.rateDot_0[2]-(params.G2[2]*params.omegaDot_0[0]+params.G2[5]*params.omegaDot_0[1]+params.G2[8]*params.omegaDot_0[2]+params.G2[11]*params.omegaDot_0[3])))+params.gamma_yaw[0]*(params.yawRateMag_sq[0]-(params.rate_yaw[0]*params.rate_yaw[0]+params.rate_yaw[1]*params.rate_yaw[1]+params.rate_yaw[2]*params.rate_yaw[2]));
}
void fillb(void) {
}
void pre_ops(void) {
